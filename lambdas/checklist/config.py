...
class Config:
    ...
    EVALUATION_PROCESSOR_QUEUE_URL = os.environ.get('EVALUATION_PROCESSOR_QUEUE_URL')
    GENERATION_PROCESSOR_QUEUE_URL = os.environ.get('GENERATION_PROCESSOR_QUEUE_URL')
